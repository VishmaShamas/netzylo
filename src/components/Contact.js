        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div
                className="card p-6 text-center shadow-theme-lg backdrop-blur-lg animate-slide-up"
              ...
              >
                <div className="text-3xl font-bold text-theme-button mb-2">
                  99.9%
                </div>
          ...
          {/* Contact Form */}
          <div
            className="card p-8 shadow-theme-xl backdrop-blur-lg animate-slide-up"
            style={{ animationDelay: "100ms" }}
          >
            <h3 className="text-2xl font-bold mb-6 text-theme-text">
